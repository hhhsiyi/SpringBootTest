...
import com.hewen.service.AppConfig;
import com.hewen.service.UserInterface;
import com.hewen.spring.Autowired;
import com.hewen.spring.HewenApplicationContext;
...
public class MyTest {
    ...
    public static void main(String[] args) {
        HewenApplicationContext context = new HewenApplicationContext(AppConfig.class);
//        UserService hewenUserService = (UserService)context.getBean("hewenUserService");
//        System.out.println((UserService) context.getBean("userService"));
//        System.out.println((UserService) context.getBean("userService"));
//        System.out.println((UserService) context.getBean("userService"));
//        System.out.println((UserService) context.getBean("hewenUserService"));
//        System.out.println((UserService) context.getBean("hewenUserService"));
